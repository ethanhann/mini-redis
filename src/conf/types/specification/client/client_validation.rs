...
range_constraint!(READ_BUFFER_RANGE, u32, min: 1024, max: 65536, units: " bytes", help: "Buffer sizes below 1KB hurt throughput; above 64KB waste memory per connection.");
range_constraint!(PUB_SUB_CAPACITY_RANGE, u32, min: 1, max: 65536, help: "Large capacities hold more messages for slow subscribers but use more memory.");
